...
<html data-wf-page="5baddb6a35e11306e19a4806" data-wf-site="5badda2935e11303a89a461e"
  data-wf-collection="5baddb6a35e1130af59a4804" data-wf-item-slug="mega-plush-toy">
...
<body>
  ...
  site {
        ...
        <div class="product">
          <div class="product-info">
            ...
            <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
              class="product-price">Rp. 300.000 IDR</div>
            <div class="full-width">
              <form data-node-type="commerce-add-to-cart-form" data-commerce-sku-id="5bae12591c68cc62c625c461"
                data-loading-text="Adding to cart..." data-commerce-product-id="5bae12599395551b46b8b58a"
          ...
          <div class="product-details-wrapper">
            <div class="shop-header">
              ...
              <div class="sku">
                <div>SKU: </div>
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_sku_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">35010
                </div>
              </div>
            ...
            <div class="product-table">
              <div class="product-table-cell">
                ...
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_width_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">18
                  </div>
                  <div>  in</div>
                </div>
              </div>
              <div class="product-table-cell">
                <div>Height</div>
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_height_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">16.6
                  </div>
                  <div>  in</div>
                </div>
              </div>
              <div class="product-table-cell">
                <div>Length</div>
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_length_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">12.4
                  </div>
                  <div>  in</div>
                </div>
              </div>
              <div class="product-table-cell no-border-bottom">
                <div>Weight</div>
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_weight_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">10
                  </div>
                  <div>  oz</div>
                </div>
              </div>
    ...
    <div class="section">
      <div class="wrapper">
        <div class="shop-header">
          <h3>Related Products</h3><a href="../category/pakaian.php" class="link arrow-link">See All</a>
          <div class="shop-header-line">
        ...
        <div class="full-width w-dyn-list">
          <div role="list" class="products w-dyn-items">
            <div data-w-id="df75c36d-8d89-3a15-6c0d-6078372525bd" style="opacity:0" role="listitem"
              class="product-card-wrapper w-dyn-item"><a href="kebaya jogja.php" class="product-card w-inline-block">
            ...
            <div data-w-id="df75c36d-8d89-3a15-6c0d-6078372525bd" style="opacity:0" role="listitem"
              class="product-card-wrapper w-dyn-item"><a href="dress batik.php"
                class="product-card w-inline-block">
                <div class="product-card-image-wrapper"><img alt=""
                    data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
            ...
            <div data-w-id="df75c36d-8d89-3a15-6c0d-6078372525bd" style="opacity:0" role="listitem"
              class="product-card-wrapper w-dyn-item"><a href="batik cowo.php"
                class="product-card w-inline-block">
                <div class="product-card-image-wrapper"><img alt=""
                    data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
            ...
            <div data-w-id="df75c36d-8d89-3a15-6c0d-6078372525bd" style="opacity:0" role="listitem"
              class="product-card-wrapper w-dyn-item"><a href="lurik-perempuan.php"
                class="product-card w-inline-block">
                <div class="product-card-image-wrapper"><img alt=""
                    data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
