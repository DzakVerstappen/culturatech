...
<html data-wf-page="5baddb6a35e11306e19a4806" data-wf-site="5badda2935e11303a89a461e"
  data-wf-collection="5baddb6a35e1130af59a4804" data-wf-item-slug="christmas-deer">
  ...
  site {
        ...
        <div class="product">
          <div class="product-info">
            ...
            <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
              class="product-price">Rp. 200.000 IDR</div>
            <div class="full-width">
              <form data-node-type="commerce-add-to-cart-form" data-commerce-sku-id="5bae0ee8e50550cee7dcff42"
                data-loading-text="Adding to cart..." data-commerce-product-id="5bae0ee71f2da275d7173682"
          ...
          <div class="product-details-wrapper">
            <div class="shop-header">
              ...
              <div class="sku">
                <div>SKU: </div>
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_sku_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">35013
                </div>
              </div>
            ...
            <div class="product-table">
              <div class="product-table-cell">
                ...
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_width_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">32
                  </div>
                  <div>  in</div>
                </div>
              </div>
              <div class="product-table-cell">
                <div>Height</div>
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_height_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">14
                  </div>
                  <div>  in</div>
                </div>
              </div>
              ...
              <div class="product-table-cell no-border-bottom">
                <div>Weight</div>
                <div class="product-table-info">
                  <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_weight_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">9.5
                  </div>
                  <div>  oz</div>
                </div>
              </div>
          ...
          <div role="list" class="products w-dyn-items">
            <div data-w-id="df75c36d-8d89-3a15-6c0d-6078372525bd" style="opacity:0" role="listitem"
              class="product-card-wrapper w-dyn-item"><a href="kebaya kutu.php"
                ...
                <h6 class="product-card-heading">Kebaya Kuru Baru</h6>
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
    ...
    <div class="section color no-padding-vertical">
      <div class="wrapper text-white">
        <div class="footer">
          <div class="footer-left"><a href="../category/pakaian.php" class="footer-brand w-nav-brand">
              <div>Shopify</div>
            </a></div>
